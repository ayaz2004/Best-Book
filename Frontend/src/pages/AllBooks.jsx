      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {books.map((book,index) => (
            <motion.div
              key={book._id}
              className="bg-white/80 backdrop-blur-sm w-60 rounded-3xl shadow-sm overflow-hidden hover:shadow-xl transition-shadow duration-300 m-3 hover:border-2 hover:border-purple-500"
