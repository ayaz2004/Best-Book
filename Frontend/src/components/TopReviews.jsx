...
function TopReviews() {
  ...
  const fetchPopularReviews = async () => {
    ...
    try {
      ...
      const sortedReviews = data.reviews.sort((a, b) => b.rating - a.rating).slice(0, 6);
     ...
     {loading ? (
        ...
        <div className="w-full bg-gradient-to-br from-slate-800 via-slate-800 to-purple-900 rounded-lg m-2 shadow-xl p-6">
          <div className="mb-8">
            ...
            <p className="text-purple-400 text-sm mt-1">Check out our top reviews</p>
          </div>
          {popularReviews.length > 0 ? (
            <div className="overflow-hidden">
              ...
              >
                <div className="flex">
                  {[...popularReviews, ...popularReviews].map((review, index) => (
                    <div key={review._id + index} className="w-[400px] flex-shrink-0 px-4">
